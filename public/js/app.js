...
document.addEventListener('alpine:init', function () {
  alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('game', function () {
...
var wotd = _names__WEBPACK_IMPORTED_MODULE_1__["default"].data.filter(function (name) {
  return name.day === today;
}); // theWord: names.data[Math.floor(Math.random()*names.data.length)],

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  //theWord: wotd[0],
  theWord: _names__WEBPACK_IMPORTED_MODULE_1__["default"].data[Math.floor(Math.random() * _names__WEBPACK_IMPORTED_MODULE_1__["default"].data.length)],
  guessesAllowed: 5,
  currentRowIndex: 0,
  state: 'active',
  errors: false,
  ...
  init: function init() {
    ...
    this.board = Array.from({
      ...
      return Array.from({
        length: _this.theWord.name.length
      }, function (item, index) {
  ...
  submitGuess: function submitGuess() {
    ...
    if (!_names__WEBPACK_IMPORTED_MODULE_1__["default"].data.find(function (data) {
      return data.name === _this2.currentGuess;
    })) {
      this.errors = true;
    ...
    _Tile__WEBPACK_IMPORTED_MODULE_0__["default"].updateStatusForRow(this.currentRow, this.theWord.name);
